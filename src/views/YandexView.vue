...
const achivments = 'Сверстал лендинг для Яндекса. Задача была сделана за 6 часов при помощи HTML/CSS/VITE. Сайт получился адаптивным и с анимациями'
...
const images = [
    '/img/yandex/yandex1.jpeg',
    '/img/yandex/yandex2.jpeg',
    '/img/yandex/yandex3.jpeg',
    '/img/yandex/yandex4.jpeg',
    '/img/yandex/yandex5.jpeg',
]
